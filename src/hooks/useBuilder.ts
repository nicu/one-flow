...
import type { BuilderComponent, ComponentType, ComponentProperties } from '../types';
...
export const useBuilder = () => {
  ...
  const updateComponent = useCallback((id: string, properties: Partial<ComponentProperties>) => {
...
const removeComponentById = (components: BuilderComponent[], id: string): BuilderComponent[] => {
  return components
